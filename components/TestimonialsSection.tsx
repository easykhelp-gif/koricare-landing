...
const testimonials = [
  {
    ...
    text: "ขอบคุณ Easy-K มากเลยค่ะ ช่วยจองคลินิกให้ และแปลใบสรุปโรคด้วย ไม่รู้จะทำยังไงถ้าไม่มีทีมนี้ 🙏",
    stars: 5,
    avatar: "🧑‍💼",
  },
  {
    ...
    text: "สั่งของ Coupang ไม่เป็น Easy-K ช่วยสั่งให้ ได้ของเร็วมาก บริการดีมากครับ แนะนำเลย!",
    stars: 5,
    avatar: "🎓",
  },
  {
    ...
    flag: "🇹🇭",
    role: "พยาบาลที่ปูซาน",
    text: "ปัญหาสัญญาเช่าบ้าน Easy-K ช่วยอ่านและอธิบายให้เข้าใจหมดเลยค่ะ รู้สึกอุ่นใจมาก เหมือนมีเพื่อนจริงๆ",
    stars: 5,
    avatar: "👩‍⚕️",
  },
];
