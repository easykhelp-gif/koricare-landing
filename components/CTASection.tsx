    ...
    >
      ...
      >
        ...
        >
          อย่าเก็บความลำบาก
          <br />
          <span style={{ color: "#002366" }}>ไว้คนเดียว</span>
        </h2>
        ...
        >
          ให้ Easy-K เป็นเพื่อนคู่คิดของคุณ
          <br />
          เราพร้อมรับฟังและช่วยเหลือคุณ
          <br />
          <span style={{ color: "#002366", fontWeight: 600 }}>
            ทุกวัน ทุกเวลา ไม่มีค่าใช้จ่าย
          </span>
        </p>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12, position: "relative" }}>
          <a
            id="cta-line-btn"
            href="https://line.me/ti/g2/YOUR_LINE_LINK"
            target="_blank"
          ...
          <a
            id="cta-fb-btn"
            href="https://www.facebook.com/YOUR_FB_PAGE"
            target="_blank"
            rel="noopener noreferrer"
            style={{
              display: "flex",
