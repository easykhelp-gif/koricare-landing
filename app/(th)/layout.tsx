...
export const metadata: Metadata = {
  ...
  openGraph: {
    // ปรึกษาเราได้ / ไม่มีค่าใช้จ่าย — 정중하면서 문턱이 낮은 말. ฟรี 보다 격식 있다.
    title: "Kori Care | คู่มือใช้ชีวิตในเกาหลี",
    description: "เงินชดเชย ค่าจ้างค้างจ่าย โรงพยาบาล เอกสารราชการ ไปจนถึงการหาที่พัก — เรื่องการใช้ชีวิตในเกาหลี ปรึกษาเราได้ ไม่มีค่าใช้จ่าย",
    type: "website",
    siteName: "Kori Care",
