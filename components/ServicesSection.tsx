...
const services = [
  {
    id: "shopping",
    emoji: "🛍️",
    title: "ช่วยช้อปปิ้งออนไลน์แทนคุณ",
    desc: "Coupang, Musinsa, 11Street และแพลตฟอร์มเกาหลีทุกชนิด เราสั่งให้คุณได้เลย ไม่ต้องใช้ภาษาเกาหลี",
    color: "#e8f0ff",
  ...
  },
  {
    id: "reservation",
    emoji: "📋",
    title: "ช่วยจองคิวและประสานงานต่างๆ",
    desc: "จองร้านอาหาร โรงพยาบาล ธนาคาร หรือนัดหมายใดก็ได้ เราโทรและจัดการให้คุณ",
    color: "#e8fff0",
  ...
  },
  {
    id: "consult",
    emoji: "💬",
    title: "ปรึกษาปัญหาการใช้ชีวิตในเกาหลีได้ฟรี!",
    desc: "วีซ่า สัญญาเช่า ปัญหากับเพื่อนร่วมงาน หรือแค่อยากระบาย เราอยู่ตรงนี้เสมอ",
    color: "#fff8e8",
  ...
  },
  {
    id: "translate",
    emoji: "🔤",
    title: "แปลเอกสารและช่วยกรอกฟอร์ม",
    desc: "ฟอร์มราชการ จดหมายจากเจ้าของบ้าน สัญญาต่างๆ เราแปลและอธิบายให้เข้าใจง่าย",
    color: "#f0e8ff",
